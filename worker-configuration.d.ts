/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd4a56508f57c4dfa68c4edade8353f5)
// Runtime types generated with workerd@1.20260706.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	...
	SLIDES_WORKFLOW: Workflow<Parameters<import("./src/server").SlidesWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLM_PROVIDER" | "LLM_MODEL" | "LLM_BASE_URL" | "LLM_CONCURRENCY" | "LLM_API_KEY" | "ALERT_WEBHOOK_URL">> {}
}
